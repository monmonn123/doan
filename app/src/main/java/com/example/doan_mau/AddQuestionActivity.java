...
public class AddQuestionActivity extends AppCompatActivity {
    ...
    private void submitQuestion() {
        ...
        // Tạo request body theo cấu trúc API của bạn
        ...
        // Gửi lên server (API yêu cầu Multipar nếu có ảnh, ở đây ta gửi null cho ảnh)
        RetrofitClient.getApi().postQuestion(rbUserId, rbContent, null).enqueue(new Callback<ResponseBody>() {
            @Override
